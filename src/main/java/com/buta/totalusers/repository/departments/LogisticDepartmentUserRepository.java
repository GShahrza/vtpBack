package com.buta.totalusers.repository.departments;
...
@Repository
public interface LogisticDepartmentUserRepository extends JpaRepository<User,Integer> {
    @Query(value = "select u.ages,u.names,u.surname ,u.email ,u.phone,\n" +
            ...
            " where u.department_id =3", nativeQuery = true)
    List<String> findLogisticUsers();
}
